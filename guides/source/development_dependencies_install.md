...
```bash
$ sudo apt update
$ sudo apt install sqlite3 libsqlite3-dev libmariadb-dev mariadb-server postgresql-server-dev-all postgresql-client postgresql-contrib libpq-dev redis-server memcached imagemagick ffmpeg mupdf mupdf-tools libxml2-dev
